...
def build_opencv(srcroot, buildroot, target, arch):
    ...
    cmakeargs = ("-GXcode " +
                ...
                "-DWITHOUT_SERVER=1 " +
                "-DWITHOUT_TESTAPPS=1 " +
                "-DCMAKE_INSTALL_PREFIX:PATH=/Users/james/Project/libwebsockets/install-%s") % (srcroot, target, arch)
...
def build_framework(srcroot, dstroot):
    ...
    # Build arm64
    build_opencv(srcroot, os.path.join(dstroot, "build"), "iPhoneOS", "arm64")
